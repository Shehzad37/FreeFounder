...
<ul class="breadcrumb">
          ...
          <li class="active">Compairing Laptops</li>
</ul>
<?php 
...
if (isset($_POST['submit'])) {
	...
	$object1=new Home();
	$object2=new Home();
	$product1=$object1->get_laptop_detail($product_1);
	$product2=$object2->get_laptop_detail($product_2);
}
?>
	<h3> Laptops Compairsition <small class="pull-right"> 2 products are compaired </small></h3>	
	<hr class="soft"/>
...
<?php foreach($product1 as $row1){
        ...
        $pixel1 = $row1['pixel']; 
        $cache1 = $row1['cache'];
        $graphic_card1 = $row1['graphic_card'];  
        $video1 = $row1['video'];    
?>   <?php  } ?>
...
<?php foreach($product2 as $row2){
        ...
        $pixel2 = $row2['pixel']; 
        $cache2 = $row2['cache'];
        $graphic_card2 = $row2['graphic_card'];  
        $video2 = $row2['video'];    
?>   <?php  } ?> 
              ...
              <tbody>
				...
				<tr>
                  <td>Resolution</td>
                  <td><?php echo  $resolution1; ?></td>
                  <td><?php echo  $resolution2; ?></td>
                </tr>
                <tr>
                  <td>Pixel</td>
                  <td><?php echo  $pixel1; ?></td>
                  <td><?php echo  $pixel2; ?></td>
                </tr>
                <tr>
                <tr>
                  <td>Cache</td>
                  <td><?php echo  $cache1; ?></td>
                  <td><?php echo  $cache2; ?></td>
                </tr>
                <tr>
                  <td>Graphic Card</td>
                  <td><?php echo  $graphic_card1; ?></td>
                  <td><?php echo  $graphic_card2; ?></td>
                </tr>
                <tr>
                  <td>Video Preview</td>
