...
<ul class="breadcrumb">
    			...
    			<li><a href="car_ads.php">Cars Ads</a> <span class="divider">/</span></li>
	...
	<div class="row">	  
			...
			<div class="span4">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>Price   $<?php echo  $product_price; ?></span></label>	  
				  </div>
				</form>	
				<hr class="soft"/>
				<h4>  </h4>		
            ...
            <ul id="productDetail" class="nav nav-tabs">
            	...
            	<li><a href="#product_detail" data-toggle="tab">Actual Car Details</a></li>           
            </ul>
