...
<head>
    <meta charset="utf-8">
    <title>Car Showroom Locations</title>
...
?>
				<tr class="techSpecRow">
                    ...
                    <th><a href="delete_cell_location.php?delete=<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete selected car Location?')" >Delete</a></th>
