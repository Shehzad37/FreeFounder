...
<?php
	...
	$obj=new Home();
	$count=$obj->count_laptop_all();
	

    $object=new Home();
    $data=$object->get_laptop_all();
...
<ul class="breadcrumb">
    			...
    			<li class="active">All Laptops</li>
</ul>
	<h3> All Laptops <small class="pull-right"><?php echo  $count; ?> products are available </small></h3>	
	<hr class="soft"/>
...
<?php  } ?>	
 ...
 <div class="well">
    	<form class="form-inline navbar-search" method="post" action="filter_laptop_all.php" >
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<?php include("includes/list_laptop_all.php"); ?>
		<hr class="soft"/>
	</div>

	<div class="tab-pane  active" id="blockView">
		<?php include("includes/block_laptop_all.php");?>
	<hr class="soft"/>
	</div>
</div>
	<div class="well">
