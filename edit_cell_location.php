...
<head>
    <meta charset="utf-8">
    <title>Update Cell Phone Location</title>
...
<!-- Sidebar end=============================================== -->
	<div class="span9" style="height:auto;">
		<div class="well">
        	<h2>Update cell Phone Location</h2>
...
<?php
    ...
    $data=$object->get_product_location($edit_id);
...
if (isset($_POST['update'])) {
	...
	$object=new AdminPost();
	$object->update_cell_location($product,$city,$address,$update_id);
}
?>		
