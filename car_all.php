...
<?php
	...
	$obj=new Home();
	$count=$obj->count_car_all();
	

    $object=new Home();
    $data=$object->get_car_all();
...
<ul class="breadcrumb">
	...
	<h3> All Cars <small class="pull-right"> <?php echo  $count; ?> products are available </small></h3>	
	<hr class="soft"/>
...
<div class="well">
    	<form class="form-inline navbar-search" method="post" action="filter_car_all.php" >
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<?php include("includes/list_car_all.php"); ?>
		<hr class="soft"/>
	</div>

	<div class="tab-pane  active" id="blockView">
		<?php include("includes/block_car_all.php");?>
	<hr class="soft"/>
	</div>
</div>
	<div class="well"><form class="form-inline navbar-search" method="post" action="compair_car.php" >
