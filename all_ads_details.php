...
<?php
	...
	$object1=new Home();
	$data=$object1->get_product_ads_detail($ads_id);
	$obj=new Home();
	$user_id=$obj->get_userId($ads_id);
	$object=new Home();
	$sql=$object->get_user_detail($user_id);
...
<ul class="breadcrumb">
    			...
    			<li><a href="all_ads.php">All Ads</a> <span class="divider">/</span></li>
	...
	<div class="row">	  
			...
			<div class="span4">
				...
				<a class="btn btn-small pull-right" href="#profile">Poster Details</a>
            ...
            <ul id="productDetail" class="nav nav-tabs">
            	...
            	<li><a href="#product_detail" data-toggle="tab">Actual Products Details</a></li>          
            </ul>
