...
<?php
	...
	$obj=new Home();
	$count=$obj->count_cell_category($cell_name);
	

    $object=new Home();
    $data=$object->get_cell($cell_name);
...
<?php  } ?>	
 ...
 <div class="well">
    	<form class="form-inline navbar-search" method="post" action="filter_cell.php" >
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<?php include("includes/listproducts_cell.php"); ?>
		<hr class="soft"/>
	</div>

	<div class="tab-pane  active" id="blockView">
		<?php include("includes/blockproducts_cell.php");?>
	<hr class="soft"/>
	</div>
</div>
	<div class="well">
